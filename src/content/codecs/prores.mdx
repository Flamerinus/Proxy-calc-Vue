...
**Apple ProRes** is one of the most popular <a href = {Base + "/docs/codec"} class="underline">codecs</a> in professional 
post‑production. It allows working with full‑frame, 10 and 12 bit <a href = {Base + "/docs/colordepth"} class="underline">color depth</a>, 4:2:2 and 4:4:4:4 <a href = {Base + "/docs/chroma"} class="underline">chroma subsampling</a>,
...
on <a href = {Base + "/docs/codec"} class="underline">codec</a> type, image content, frame size, and <a href = {Base + "/docs/fps"} class="underline">frame rate</a>.\
\
As a variable bit rate (<a href = {Base + "/docs/bitrate"} class="underline">VBR</a>) codec technology, ProRes uses fewer bits on 
...
\
All ProRes codecs are <a href = {Base + "/docs/all-intra"} class="underline">frame independent</a> (or “intra‑frame”) codecs, 
...
4:4:4:4 image sources (including <a href = {Base + "/docs/alpha"} class="underline">alpha channels</a>), with a very high data 
...
performance and a mathematically lossless <a href = {Base + "/docs/alpha"} class="underline">alpha channel</a> up to 
...
sources at 10‑bit <a href = {Base + "/docs/colordepth"} class="underline">pixel depths</a>, while remaining visually lossless through 
